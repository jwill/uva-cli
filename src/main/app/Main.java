...
import adapter.*;
import j.io.FileUtil;
import j.io.PathUtil;
...
public class Main {
  ...
  public void load(String optFilePath) throws Exception {
  ...
  public void save(String optFilePath)
    ...
    try {
      bw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(optFilePath), "utf-8"));
  ...
  private void dispatch(String action, String[] toks) throws Exception {
    if (action.equals("add")) {
      ...
      String [] text = new String[]{
              ...
              "exit Quits the application (can also use quit.)"
      };
      for (String s : text) {
